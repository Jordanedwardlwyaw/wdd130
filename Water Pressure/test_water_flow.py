...
def test_pressure_gain_from_water_height():
    ...
    assert pressure_gain_from_water_height(50.0) == approx(489.845, abs=0.001)

def test_pressure_loss_from_pipe():
    assert pressure_loss_from_pipe(0.048692, 0.0, 0.018, 1.75) == approx(0.0, abs=0.001)
    assert pressure_loss_from_pipe(0.048692, 20.0, 0.018, 0.0) == approx(0.0, abs=0.001)
    assert pressure_loss_from_pipe(0.048692, 20.0, 0.018, 1.75) == approx(-40.396, abs=0.001)
    assert pressure_loss_from_pipe(0.048692, 200.0, 0.018, 1.75) == approx(-403.963, abs=0.001)
...
def test_kpa_to_psi():
    ...
    assert kpa_to_psi(1) == approx(0.145038, abs=0.0001)
    assert kpa_to_psi(100) == approx(14.5038, abs=0.0001)
    assert kpa_to_psi(158.7) == approx(23.0176, abs=0.0001)
